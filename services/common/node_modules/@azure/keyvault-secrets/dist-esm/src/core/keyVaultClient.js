...
var createKeyOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.KeyCreateParameters, { required: true })
    },
    responses: {
        200: {
...
var importKeyOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.KeyImportParameters, { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.KeyBundle
...
var updateKeyOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.KeyUpdateParameters, { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.KeyBundle
...
var restoreKeyOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.KeyRestoreParameters, { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.KeyBundle
...
var encryptOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.KeyOperationsParameters, { required: true })
    },
    responses: {
        200: {
...
var signOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.KeySignParameters, { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.KeyOperationResult
...
var verifyOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.KeyVerifyParameters, { required: true })
    },
    responses: {
        200: {
...
var setSecretOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.SecretSetParameters, { required: true })
    },
    responses: {
        200: {
...
var updateSecretOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.SecretUpdateParameters, { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.SecretBundle
...
var restoreSecretOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.SecretRestoreParameters, { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.SecretBundle
...
var setCertificateContactsOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.Contacts, { required: true })
    },
    responses: {
        200: {
...
var setCertificateIssuerOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.CertificateIssuerSetParameters, { required: true })
    },
    responses: {
        200: {
...
var updateCertificateIssuerOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.CertificateIssuerUpdateParameters, { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.IssuerBundle
...
var createCertificateOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.CertificateCreateParameters, { required: true })
    },
    responses: {
        202: {
...
var importCertificateOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.CertificateImportParameters, { required: true })
    },
    responses: {
        200: {
...
var updateCertificatePolicyOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.CertificatePolicy, { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.CertificatePolicy
...
var updateCertificateOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.CertificateUpdateParameters, { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.CertificateBundle
...
var updateCertificateOperationOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.CertificateOperationUpdateParameter, { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.CertificateOperation
...
var mergeCertificateOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.CertificateMergeParameters, { required: true })
    },
    responses: {
        201: {
            bodyMapper: Mappers.CertificateBundle
...
var restoreCertificateOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.CertificateRestoreParameters, { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.CertificateBundle
...
var restoreStorageAccountOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.StorageRestoreParameters, { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.StorageBundle
...
var regenerateStorageAccountKeyOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.StorageAccountRegenerteKeyParameters, { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.StorageBundle
...
var setSasDefinitionOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.SasDefinitionCreateParameters, { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.SasDefinitionBundle
...
var updateSasDefinitionOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib_1.__assign({}, Mappers.SasDefinitionUpdateParameters, { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.SasDefinitionBundle
