...
function getNextLastDayOfMonth({
  ...
  while (dateCursor < end) {
    ...
    const nextOccurrenceEnd = _momentTimezone.default.tz(startOfMonth, timezone).endOf(_scheduling.Unit.Month).add(1, _scheduling.Unit.Day).startOf(_scheduling.Unit.Day).valueOf();
    ...
    const nextDateCursor = _momentTimezone.default.tz(startOfMonth, timezone).add(1, _scheduling.Unit.Month).valueOf();
