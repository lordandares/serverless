...
function handleFullLoadEmployees(_a, winteamTenant) {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, upsertUser_1.upsertUser({
...
exports.default = handleFullLoadEmployees;
function log(text) {
    var len = text.length;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    url = "" + process.env.WINTEAM_BASE_URL + process.env.EMPLOYEES_ENDPOINT;
                    headers = {
