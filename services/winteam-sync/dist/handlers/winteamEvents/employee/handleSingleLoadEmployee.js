...
var upsertUser_1 = require("../../helpers/upsertUser");
var validations_1 = require("../../helpers/validations");
var Env;
(function (Env) {
    Env["EMPLOYEES_ENDPOINT"] = "EMPLOYEES_ENDPOINT";
    Env["WINTEAM_BASE_URL"] = "WINTEAM_BASE_URL";
    Env["AZURE_KEY_VAULT"] = "AZURE_KEY_VAULT";
})(Env || (Env = {}));
function handleSingleLoadEmployee(_a, winteamTenant) {
    var context = _a.context, data = _a.data;
    return __awaiter(this, void 0, void 0, function () {
        var PrimaryKeyValue, employee, err, applicationId, applicationCollection, application;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    validations_1.validateError({ context: context, data: data }, 'PrimaryKeyValue');
                    PrimaryKeyValue = data.PrimaryKeyValue;
                    return [4 /*yield*/, getEmployee(PrimaryKeyValue, winteamTenant.mappings.filter(function (x) { return x['productId'] === 'winteam'; })[0]['tenantId'])];
                case 1:
                    employee = _b.sent();
                    context.log.info("Winteam Employee request completed: ");
                    context.log.info(employee);
                    if (!employee) {
                        err = new Error('EmployeeNotFoundError');
                ...
                case 3:
                    ...
                    return [2 /*return*/, upsertUser_1.upsertUser({
...
exports.default = handleSingleLoadEmployee;
function getEmployee(employeeID, winteamTenantId) {
    return __awaiter(this, void 0, void 0, function () {
        var subscriptionKey, request, employee;
