            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        artifactName = this.getArtifactName(deployment.name);
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        // Initialize blob service for either creating SAS token or downloading artifact to uplod to function app
                        _c.sent();
                        if (!this.deploymentConfig.runFromBlobUrl) return [3 /*break*/, 4];
                        // Set functionRunFromPackage param to SAS URL of blob
                        _a = armDeployment.parameters;
                        _b = {
                            type: armTemplates_1.ArmParamType.String
                        };
                        return [4 /*yield*/, this.blobService.generateBlobSasTokenUrl(this.deploymentConfig.container, artifactName)];
                    case 3:
                        // Set functionRunFromPackage param to SAS URL of blob
                    ...
                    case 5:
                        _c.sent();
                        if (!!this.deploymentConfig.runFromBlobUrl) return [3 /*break*/, 8];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.blobService.downloadBinary(this.deploymentConfig.container, artifactName, artifactPath)];
                    case 1:
                        _a.sent();
