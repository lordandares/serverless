...
var ArmService = /** @class */ (function (_super) {
    ...
    ArmService.prototype.createDeploymentFromType = function (type) {
        return __awaiter(this, void 0, void 0, function () {
            var ApimResource, apimResource, template, e_1, azureConfig, mergedTemplate, parameters, apimTemplate, apimParameters;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        azureConfig = this.serverless.service;
                        mergedTemplate = template.getTemplate();
                        parameters = template.getParameters(azureConfig);
                        if (this.config.provider.apim) {
                            apimTemplate = apimResource.getTemplate();
                            apimParameters = apimResource.getParameters(azureConfig);
