...
var AzureNamingService = /** @class */ (function () {
    ...
    AzureNamingService.getResourceName = function (options) {
        ...
        if (options.includeHash) {
            name += "-" + md5_1.default(options.config.provider.resourceGroup).substr(0, config_1.default.resourceGroupHashLength);
        }
        if (options.suffix) {
            name += "-" + options.suffix;
        }
    ...
    AzureNamingService.getSafeResourceName = function (options) {
        ...
        var hashLength = (options.includeHash) ? config_1.default.resourceGroupHashLength : 0;
    ...
    AzureNamingService.getDeploymentName = function (config, timestamp) {
        var maxLength = config_1.default.naming.maxLength.deploymentName;
        var suffix = config_1.default.naming.suffix.deployment;
