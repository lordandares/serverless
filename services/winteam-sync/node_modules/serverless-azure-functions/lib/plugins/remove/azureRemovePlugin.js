    ...
    AzureRemovePlugin.prototype.remove = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        resourceClient = new resourceService_1.ResourceService(this.serverless, this.options);
                        return [4 /*yield*/, resourceClient.deleteDeployment()];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, resourceClient.deleteResourceGroup()];
                    case 2:
                        _a.sent();
